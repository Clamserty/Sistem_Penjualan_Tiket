...
/**
 * Panel "Transaksi" yang menampilkan form kasir untuk melakukan transaksi penjualan tiket dan tabel riwayat transaksi.
 * Panel ini menggunakan layout BorderLayout untuk menyusun form kasir di atas dan tabel riwayat di bawah.
 * Menggunakan TiketDao dan TransaksiDao untuk mengelola data tiket dan transaksi dari database.
...
// Panel TransaksiPanel untuk mengelola transaksi penjualan tiket
public class TransaksiPanel extends JPanel {
    ...
    // Konstruktor untuk membuat panel TransaksiPanel
    ...
    // Inisialisasi komponen panel TransaksiPanel
    ...
    // --- METODE UNTUK MEMUAT DATA TIKET AKTIF KE COMBO BOX ---
    ...
    // -- METODE UNTUK MEMUAT DATA RIWAYAT TRANSAKSI KE TABEL ---
    ...
    // --- METODE UNTUK MENANGANI PILIHAN TIKET DARI COMBO BOX ---
    private void aksiPilihTiket() {
        int index = cbTiket.getSelectedIndex();
        // Jika index 0 (placeholder) atau listTiketActive null, reset form kasir
        ...
        // Jika tiket valid dipilih, tampilkan stok dan harga di form kasir
    ...
    // -- METODE UNTUK MENGHITUNG TOTAL HARGA DAN KEMBALIAN ---
    private boolean hitungTotalDanKembalian(boolean silent) {
        // Validasi tiket terpilih
        ...
        // Tangkap kesalahan input non-angka
    ...
    // -- METODE UNTUK MEMPROSES TRANSAKSI KASIR DAN MENYIMPAN KE DATABASE ---
    ...
    // --- METODE UNTUK MEMBERSIHKAN FORM INPUT DAN MENGEMBALIKAN STATUS TOMBOL ---
